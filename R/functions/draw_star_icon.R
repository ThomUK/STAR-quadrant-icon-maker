draw_star_icon <- function(colour_string){
  ...
  grid.draw(white_circle(radius = 0.58, line_width = 52))
  grid.draw(black_circle(radius = 0.43, line_width = 10))
  grid.draw(black_line(x = 0.5, y = 0.5, width = 0.95, height = 0.05))
  grid.draw(black_line(x = 0.5, y = 0.5, width = 0.05, height = 0.95))
  grid.draw(text_label("S", 0.3, 0.7))
  grid.draw(text_label("T", 0.7, 0.7))
  grid.draw(text_label("A", 0.3, 0.3))
  grid.draw(text_label("R", 0.7, 0.3))
